    ...
    <RelatedProductStyle>
        {
            relativeList.map((item, index) => (
                <MenuCard key={item.menu_id} menu_id={item.menu_id} name={item.name} price={item.price} accumulate_mileage={item.accumulate_mileage} image={item.image} isCountSix={true}/>
            ))
        }
    </RelatedProductStyle>
    </>
